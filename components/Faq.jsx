  ...
  const faqs = [
    {
      ...
      answer: "Seasides is India's premier FREE cybersecurity conference taking place at International Centre Goa from February 19-21, 2026. It's a community-driven event designed to bring together cybersecurity professionals, students, and enthusiasts for learning, networking, and knowledge sharing.",
      icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
      color: 'from-blue-500 to-indigo-500'
    },
    {
      question: 'Is it really completely free to attend?',
      answer: 'Yes! Seasides is 100% FREE for all attendees. This includes access to all sessions, meals, and networking events. Our mission is to make high-quality cybersecurity education accessible to everyone, regardless of their financial situation.',
