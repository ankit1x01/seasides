    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">Check the Awesome Workshops</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {workshopCategories.map((workshop, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">{workshop.title}</h3>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8 mb-12">
          <div className="text-center">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Workshop Schedule</h3>
            <p className="text-gray-600 mb-6">All workshops are free and designed for different skill levels - from beginners to advanced practitioners.</p>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-gray-800 mb-6">Villages & Hands-on Labs</h3>
