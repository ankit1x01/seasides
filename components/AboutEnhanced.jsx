    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">About The Conference</h2>
          ...
          <div className="text-center mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Learn from industry leaders and cybersecurity experts</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Connect with like-minded professionals and build lasting relationships</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Participate in workshops and villages for practical experience</p>
              </div>
            </div>
          </div>
